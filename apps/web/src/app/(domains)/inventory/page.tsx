    ...
    <div className="flex-1 overflow-y-auto p-6 bg-surface-container-lowest">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-2 text-label-sm text-on-surface-variant mb-2">
          <span>Otto</span>
          <span>→</span>
          <span className="font-medium text-on-surface">Inventory Domain</span>
        </div>
        
        <div className="flex items-end justify-between">
          <div>
            <h1 className="text-display-sm font-semibold text-on-surface">Inventory AI Control Center</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
        <MetricPillarCard 
          ...
          primaryMetric="56 hrs"
          secondaryMetric="24 reorder tasks automated today"
          icon={Bot}
          trendUp={true}
        />
        <MetricPillarCard 
          title="AI Supplier Support"
          primaryMetric="142 queries"
          secondaryMetric="85% resolved without human"
          icon={MessageCircle}
          trendUp={true}
        />
        <MetricPillarCard 
          ...
          secondaryMetric="Top topic: Shipping Delays (41)"
          icon={Brain}
          trendUp={true}
        />
        <MetricPillarCard 
          title="AI PO Generation"
          primaryMetric="45 docs"
          secondaryMetric="32 POs • 8 Invoices • 5 Waybills"
          icon={FileText}
          trendUp={true}
        />
        <MetricPillarCard 
          title="Autonomous Supply Agents"
          primaryMetric="5 active"
          secondaryMetric="14 stock pipelines completed today"
          icon={Workflow}
        />
        <MetricPillarCard 
          title="Demand Forecasting Engine"
          primaryMetric="82 responses"
          secondaryMetric="7 high-risk stockouts detected"
          icon={Sparkles}
          trendUp={true}
        />
      </div>
