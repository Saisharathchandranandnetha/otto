...
import { Target, TrendingUp, Mail, Users, Filter, Workflow } from 'lucide-react';
    ...
    <div className="flex-1 overflow-y-auto p-6 bg-surface-container-lowest">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-2 text-label-sm text-on-surface-variant mb-2">
          <span>Otto</span>
          <span>→</span>
          <span className="font-medium text-on-surface">Sales Domain</span>
        </div>
        
        <div className="flex items-end justify-between">
          <div>
            <h1 className="text-display-sm font-semibold text-on-surface">Sales AI Control Center</h1>
            <p className="text-body-md text-on-surface-variant mt-1">Live monitoring across all 6 AI pillars</p>
          </div>
          
          <div className="flex items-center gap-4">
            <a href="/sales/workflows" className="bg-primary hover:bg-primary/90 text-on-primary px-4 py-1.5 rounded-lg text-label-md font-medium transition-colors">
              Open Workflows
            </a>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
        <MetricPillarCard 
          ...
          primaryMetric="412 leads"
          secondaryMetric="14 hot leads passed to reps"
          icon={Target}
          trendUp={true}
        />
        <MetricPillarCard 
          title="Outreach Automation"
          primaryMetric="1.2k emails"
          secondaryMetric="43% open rate"
          icon={Mail}
          trendUp={true}
        />
        <MetricPillarCard 
          ...
          primaryMetric="$4.2M"
          secondaryMetric="Forecast accuracy up 2%"
          icon={TrendingUp}
          trendUp={true}
        />
        <MetricPillarCard 
          title="Proposal Generator"
          primaryMetric="34 proposals"
          secondaryMetric="Auto-generated from CRM data"
          icon={Filter}
          trendUp={true}
        />
        <MetricPillarCard 
          ...
          secondaryMetric="11 meetings booked today"
          icon={Workflow}
        />
        <MetricPillarCard 
          title="Meeting Copilot"
          primaryMetric="18 summaries"
          secondaryMetric="Action items automatically synced"
          icon={Users}
          trendUp={true}
        />
      </div>
