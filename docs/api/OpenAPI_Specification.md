...
paths:
  /agent:
    post:
      ...
      description: Controls for demo scripts and the stage runbook (e.g., scanning triggers, simulating sales).
      requestBody:
        content:
          application/json:
            schema:
      ...
      responses:
        ...
        '400':
          description: Unknown command or invalid parameters
  ...
  /approve:
    post:
      ...
      responses:
        '200':
          description: Action state transitioned successfully
        '400':
          ...
          multipart/form-data:
            schema:
              ...
              properties:
                ...
                mode:
                  type: string
                  enum: [single, resurrection]
                  default: single
      responses:
        '200':
          description: Ingestion processed successfully
        '413':
